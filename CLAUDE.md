...
Multi-tool coding agent. Extends BaseClaude.
...
- `toolCalls` array in response tracks all tool invocations with `tool` discriminator; `codeExecutions` kept for backward compat
